"""
Script used to create 'ref_file_v_1_5_0.xml' as a reference file
that must be readable by subsequent versions of GTC.

The unit test 'test_files_v_1_5_0.py' expects to find 
'ref_file_v_1_5_0.xml' in the local directory.
"""
import os
from GTC import *
...
with open(path, mode='wb') as f:
    persistence.dump_xml(f, ar, indent=2, encoding='UTF-8', xml_declaration=True)
