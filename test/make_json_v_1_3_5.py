"""
Script used to create 'test_file_v_1_3_5.json' as a reference file 
that must be readable by subsequent versions of GTC.  

The unit test 'test_json_v_1_3_5.py' expects to find 
'test_file_v_1_3_5.json' in the local directory.
